...
const App = () => {
  ...
  return (
    <>
    <MainArr.Provider value={appleData}> 
    <Nav></Nav>
    <Slider  value={1}></Slider>
    <BestDeals value={"Best Deals"} ></BestDeals>
    <Card value={"Mobile"}></Card>
    <Slider value={0}></Slider>
    <BestDeals value={"Laptop Deals"} ></BestDeals>
    <Card value={"laptop"} ></Card>
    </MainArr.Provider>
